    ...
    datepickerDirective = function datepickerDirective($window, $compile, $locale, $filter, $interpolate, $timeout) {
      ...
      var linkingFunction = function linkingFunction($scope, element, attr) {
        ...
        var selector = attr.selector,
          ...
          theCalendar, defaultPrevButton = '<b class="_720kb-datepicker-default-button">&lang;</b>',
          ...
          pageDatepickers, hours24h = 86400000,
          htmlTemplate = generateHtmlTemplate(prevButton, nextButton, preventMobile),
          n, onClickOnWindow = function onClickOnWindow() {
          ...
          setDaysInMonth = function setDaysInMonth(month, year) {
            ...
            var i, limitDate = new Date(year, month, 0).getDate(),
              ...
              prevMonthDays = [],
              nextMonthDays = [],
              howManyNextDays, howManyPreviousDays, monthAlias, dateWeekEndDay;
